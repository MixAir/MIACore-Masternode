#!/bin/bash
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mia.conf'
CONFIGFOLDER='/root/.miacore/'
COIN_DAEMON='/usr/local/bin/miad'
COIN_CLI='/usr/local/bin/mia-cli'
COIN_REPO='https://github.com/MixAir/MIACore/releases/download/0.14.2.0/MIACore-masternode-v.0.14.2.0.tar.gz'
COIN_NAME='miacore'
COIN_PORT=36660
RPC_PORT=19901
...
function compile_node() {
  echo -e "================================================================================================================================"
  echo -e "============================================ MIACORE MASTERNODE INSTALL ========================================================"
  echo -e "================================================================================================================================"
...
addnode=37.1.214.98
addnode=177.63.224.151:50597
addnode=184.170.142.61:46734
addnode=173.249.60.153:36660
addnode=5.59.135.214:26304
addnode=184.170.142.61
EOF
}
...
function important_information() {
 ...
 echo -e "================================================================================================================================"
 echo -e "WebSite: http://mixairo.info | Discord: https://discord.gg/KVea7qV "
 echo -e "================================================================================================================================"
}
